...
@section('content')
    <div class="max-w-[52ch]">
        ...
        @if ($invoice)
            <div class="mt-6 flex flex-wrap items-baseline justify-between gap-2 rounded-[var(--radius-sm)] border border-line bg-surface-secondary px-3 py-2 text-sm">
        ...
        <div class="mt-8 flex flex-wrap gap-3">
            @if ($invoice)
                <a
                    href="{{ $invoice['url'] }}"
                    class="pressable inline-flex items-center rounded-[var(--radius-sm)] bg-brand px-5 py-2.5 text-sm font-semibold text-content-inverse shadow-(--shadow-raised)"
                >
            ...
            <a
                href="{{ url('/client') }}"
                class="pressable inline-flex items-center rounded-[var(--radius-sm)] {{ $invoice ? 'border border-line-strong' : 'bg-brand text-content-inverse shadow-(--shadow-raised)' }} px-5 py-2.5 text-sm font-semibold"
            >
