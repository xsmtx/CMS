...
/**
 * Mattermost notifications, as a module.
 *
 ...
 */
final class MattermostModule extends BaseModule
{
    ...
    public function channels(): array
    {
        ...
        return [new MattermostChannel(webhookUrl: $this->webhook, username: $this->username)];
    }
}
