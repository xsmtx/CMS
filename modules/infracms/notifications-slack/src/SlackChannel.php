...
namespace InfraCMS\NotificationsSlack;
 ...
 *
 * It has never posted to a real Slack workspace. Written against the
 * published documentation and tested against faked HTTP.
 */
final readonly class SlackChannel implements DeliversNotifications
{
    ...
    public function deliver(NotificationRecipient $recipient, RenderedMessage $message): DeliveryOutcome
    {
        ...
        return $response->successful()
            ...
            : new DeliveryOutcome(delivered: false, error: 'Slack refused the message.');
    }
