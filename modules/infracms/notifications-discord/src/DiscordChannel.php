...
/**
 * Discord, over an incoming webhook.
 *
 ...
 *
 * It has never posted to a real Discord workspace. Written against the
 * published documentation and tested against faked HTTP.
 */
final readonly class DiscordChannel implements DeliversNotifications
{
    ...
    public function deliver(NotificationRecipient $recipient, RenderedMessage $message): DeliveryOutcome
    {
        ...
        try {
            $response = Http::timeout($this->timeout)
                ...
                ->post($this->webhookUrl, [
                    ...
                    // Nobody in a room should be alerted by a billing notice.
        ...
        return $response->successful()
            ...
            : new DeliveryOutcome(delivered: false, error: 'Discord refused the message.');
    }
