      ...
      <AppCard title="Server groups" description="Placement belongs to the group, not the product.">
        ...
        >
          <tr v-for="group in groups" :key="group.id">
            ...
            <td class="px-4 py-3">{{ group.strategyLabel }}</td>
            <td class="text-content-muted px-4 py-3">{{ group.region ?? '—' }}</td>
            <td class="px-4 py-3 tabular-nums">{{ group.servers }}</td>
      ...
      <AppCard title="Servers">
        ...
        >
          <tr v-for="server in servers" :key="server.id">
            ...
            <td class="text-content-muted px-4 py-3">{{ server.group ?? '—' }}</td>
            <td class="px-4 py-3">{{ server.module }}</td>
            <td class="px-4 py-3">
            ...
            <td class="px-4 py-3 tabular-nums">{{ usage(server) }}</td>
            <td class="px-4 py-3 text-right">
              <div v-if="can.manage" class="flex justify-end gap-2">
