...
return [
    'users' => [
        ...
        'search_hint' => 'A full name works. % anchors: Zeyn% or %nep.',
        'change_for' => 'Change the password for :name',
        'description' => 'Everyone who can sign into the customer area. This is the list you open when somebody cannot get in.',
        'none_description' => "Only contacts with portal access appear here — a person on a customer's record who was never given a login is not a user.",
        'title' => 'Manage users',
    ...
    'staff' => [
        'title' => 'Staff',
        'subtitle' => 'People who can sign in to the admin area.',
        'name' => 'Name',
        'roles' => 'Roles',
        'status' => 'Status',
        'two_factor' => 'Two-factor',
        ...
        'empty_description' => 'Staff accounts are created here and activated through a password reset link, so no password is ever shared.',
