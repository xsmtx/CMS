...
return [
    ...
    'rules' => [
        ...
        'active' => 'Active',
        'inactive' => 'Off',
        'compound_badge' => 'Compound',
        'form_intro' => 'A rate is stored in parts per million, so 9.975% is exact. Type the percentage; the conversion happens once, here.',
        'delete_title' => 'Delete this tax rule?',
        'delete_detail' => 'Nothing already invoiced changes. From now on this rate stops being charged, which is the sort of change nobody notices until an invoice comes out wrong.',
