...
return [
    ...
    */
    ...
    'screen' => [
        'edit' => 'Edit role',
        'form_intro' => 'Changing a role takes effect for everyone who holds it, immediately.',
        'name' => 'Name',
        'slug' => 'Slug',
        'slug_hint' => 'Lowercase, hyphen separated. Policies and modules refer to this.',
        'scope_hint' => 'Staff roles cannot be assigned to customers, or the reverse.',
