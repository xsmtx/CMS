...
return [
    ...
    'products' => [
        'form_intro' => 'What the product is and how it is described. Prices live on their own screen.',
        'the_product' => 'The product',
        'how_it_sells' => 'How it sells',
        'group' => 'Group',
        'type' => 'Type',
        'type_hint' => 'Decides what provisioning needs and whether checkout asks for a domain.',
        'name' => 'Name',
        'slug' => 'Slug',
        'slug_hint' => 'Left empty, it is derived from the name.',
        'tagline' => 'Tagline',
        'tagline_hint' => 'One line under the product name on the storefront.',
        'description' => 'Description',
        'features' => 'Features',
        'features_hint' => 'One per line. These are the bullet points on the plan card.',
        'status' => 'Status',
        'status_hint' => 'Hidden keeps it orderable by direct link. Retired stops orders entirely.',
        'position' => 'Position',
        'stock' => 'Stock',
        'stock_hint' => 'Empty is unlimited. Zero reads as sold out.',
        'collect_domain' => 'Collect a domain at checkout',
        'domain_overridden' => 'Overridden for this product.',
        'domain_from_type' => 'Following the product type.',
        'save' => 'Save product',
