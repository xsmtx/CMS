...
return [
    'users' => [
        ...
        'description' => 'Müşteri alanında oturum açabilen herkes. Biri giriş yapamadığında açtığınız liste budur.',
        'none_description' => 'Burada yalnızca panel erişimi olan kişiler görünür — bir müşterinin kaydındaki, kendisine hiç giriş verilmemiş bir kişi kullanıcı değildir.',
