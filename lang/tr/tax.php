...
return [
    ...
    'rules' => [
        ...
        'active' => 'Etkin',
        'inactive' => 'Kapalı',
        'compound_badge' => 'Bileşik',
        'form_intro' => 'Oran milyonda bir cinsinden saklanır, böylece %9,975 tam olarak ifade edilir. Siz yüzdeyi yazın; dönüşüm bir kez, burada yapılır.',
        'delete_title' => 'Bu vergi kuralı silinsin mi?',
        'delete_detail' => 'Daha önce faturalanmış hiçbir şey değişmez. Bundan sonra bu oran tahsil edilmez; bu da bir fatura yanlış çıkana kadar kimsenin fark etmediği türden bir değişikliktir.',
        'delete_confirm' => 'Kuralı sil',
        'deleted' => 'Kaldırıldı.',
        'add' => 'Kural ekle',
        'edit' => 'Kuralı düzenle',
        'anywhere' => 'Her yer',
