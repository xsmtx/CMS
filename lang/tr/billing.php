...
return [
    ...
    'transactions' => [
        'subtitle' => 'Paranın her hareketi. Defter esastır; bir faturanın ödenen tutarı bu satırların toplamıdır.',
        'client' => 'Müşteri adı',
        'date' => 'Tarih',
        'payment_method' => 'Ödeme yöntemi',
        'description' => 'Açıklama',
        'amount_in' => 'Giren tutar',
        'amount_out' => 'Çıkan tutar',
        'fees' => 'Kesintiler',
        'invoice' => 'Fatura',
        'reference' => 'İşlem kimliği',
        'from' => 'Başlangıç',
        'to' => 'Bitiş',
        'amount' => 'Tutar',
        'in' => 'Giren',
        ...
        'flow_title' => 'Giren / çıkan tutar',
        'flow_chart' => 'Günlük giren ve çıkan tutar',
        'flow_net' => 'Gösterilen dönemde net :amount.',
        'empty' => 'İşlem yok',
        'empty_description' => 'Para hareket ettiği anda burada bir satır belirir — bir ödeme, bir iade, bir alacak.',
        'kind' => 'Tür',
        'title' => 'İşlemler',
        'add' => 'İşlem Ekle',
    ...
    'gateway_log' => [
        'title' => 'Ağ geçidi kaydı',
        'subtitle' => 'Bu platformun kabul ettiği her webhook, sağlayıcının kendi olay kimliğiyle. Yük gövdeleri gösterilmez.',
        'received' => 'Alındı',
        'gateway' => 'Ağ geçidi',
        'event' => 'Olay',
        'type' => 'Tür',
