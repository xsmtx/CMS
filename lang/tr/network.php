...
return [
    ...
    'ddos' => [
        'title' => 'Saldırılar',
        'intro' => 'Buradaki bir adrese yapıldığı bildirilen saldırılar ve arkasında kimin hizmeti olduğu.',
        'empty' => 'Bildirilen bir şey yok',
        'empty_detail' => 'Saldırılar, onları izleyen bir bağdaştırıcıdan gelir. Biri etkinleştirilene kadar gösterilecek bir şey olmaz; bu, hiçbir şey olmadığı anlamına gelmez.',
        'running' => 'Hâlâ sürüyor',
        'unattributed' => 'Bu adresi kimse tutmuyordu',
        'unattributed_detail' => 'Bu kurulumun tanımadığı ya da o sırada kimsenin tutmadığı bir adrese yapılan saldırı. Her iki durumda da bakmaya değer.',
        'impact' => 'Adreslerin arkasında ne vardı',
        'impact_intro' => 'Bu dönemde saldırıya uğrayan hizmetler ve fatura değerleri. Grafikten değil, doğrudan hizmetlerden.',
        'services' => 'Etkilenen hizmet',
        'customers' => 'Etkilenen müşteri',
        'recurring' => 'Yinelenen tutar',
        'columns' => [
            'target' => 'Adres',
            'customer' => 'Müşteri',
            'started' => 'Başlangıç',
        ...
        'filters' => [
            'all' => 'Hepsini göster',
            'running' => 'Sürenleri göster',
        ],
        'vectors' => [
            'udp_flood' => 'UDP seli',
            'icmp_flood' => 'ICMP seli',
            'dns_reflection' => 'DNS yansıması',
            'ntp_reflection' => 'NTP yansıması',
            'memcached_reflection' => 'Memcached yansıması',
            'ssdp_reflection' => 'SSDP yansıması',
            'syn_flood' => 'SYN seli',
            'ack_flood' => 'ACK seli',
            'http_flood' => 'HTTP seli',
            'tls_handshake' => 'TLS el sıkışması',
            'other' => 'Başka bir şey',
        ],
    ],
];
